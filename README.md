...
A console-based implementation of the classic Snake & Ladder board game that simulates autonomous gameplay between two players.
The game follows the official UC1–UC7 problem statement rules using multidimensional arrays, random dice rolls, and position updates.
...
<div align="center"> Made with ❤️ in C# (.NET Console) </div>
